...
<div id="content" class="intro">
  <div class="container v-centered-wrapper">
    <div class="v-centered">
      ...
      <p>
        <a class="btn btn-outline" href="<?= ROOT ?>/contatti">Entra in contatto</a>
      </p>
      <p>Sei un ispettore? <a class="uppercase" href="<?= ROOT ?>/login">Accedi</a> all'area amministrativa.</p>
    </div>
  </div>
</div>
...
<main class="container">
  ...
  <section class="service clearfix">
    <div class="service-content col half">
      ...
      <p><a href="<?= ROOT ?>/servizi#private" class="btn btn-outline">Apri servizio</a></p>
    </div>
  ...
  <section class="service clearfix">
    ...
    <div class="service-content col half">
      ...
      <p><a href="<?= ROOT ?>/servizi#aziendali" class="btn btn-outline">Apri servizio</a></p>
    </div>
  </section>
  ...
  <section class="service clearfix">
    <div class="service-content col half">
      ...
      <p><a href="<?= ROOT ?>/servizi#difensive" class="btn btn-outline">Apri servizio</a></p>
    </div>
    <div class="service-photo col half">
  ...
  <section class="service clearfix">
    ...
    <div class="service-content col half">
      ...
      <p>La nostra divisione informatica, attraverso dotazioni software all’avanguardia è in grado di offrirvi servizi di analisi forense sui dispositivi ormai di uso quotidiano come <abbr title="Personal Computer">PC</abbr>, tablet, e smartphone.</p>
