...
<main class="clearfix">
  ...
  <section class="dashboard">
    <p class="case-info">
      <span class="bold">Risolto: </span>no<br>
      <span class="bold">Tipologia: </span>omicidio<br>
      Descrizione caso... Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.<br>
    </p>
    <div class="investigation">
        ...
        <div class="investigation-content">
          <div class="investigation-content-field">
              <span class="investigation-content-title">Svolda da: </span> Sherlock Holmes<br>
          </div>
          <div class="investigation-content-field">
              <span class="investigation-content-title">Ore di lavoro: </span>5<br>
          </div>
          <div class="investigation-content-field">
            <span class="investigation-content-title">Data: </span>14.12.2017 - 20.12.2017<br>
          </div>
          <div class="investigation-content-field">
            <span class="investigation-content-title">Luogo: </span> stanza secondo piano; via blablabla n. 6, Padova (PD)<br>
          </div>
          <div class="investigation-content-field">
              <span class="investigation-content-title">Rapporto: </span>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.<br>
          </div>
          <div class="investigation-content-field">
